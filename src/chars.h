...
#define HALF_HEART_CHAR (0x01)
#define HEART_CHAR (0x02)

#define SWORD_LEFT_CHAR (0x03)
#define SWORD_RIGHT_CHAR (0x04)

#define FLAIL_LEFT_CHAR (0x05)
#define FLAIL_RIGHT_CHAR (0x06)
